...
interface ModelData {
  ...
  nodes: { id: string; name: string; status: "online" | "warning" | "offline" }[];
}
...
const modelsData: Record<string, ModelData> = {
  "1": {
    ...
    lastRun: "2 min ago",
    type: "Regression",
    description: "Predicts temperature variations in manufacturing equipment to prevent overheating and optimize cooling systems.",
    version: "2.4.1",
    ...
    logs: [
      { timestamp: "2 min ago", message: "Prediction completed successfully", type: "info" },
      { timestamp: "5 min ago", message: "Input data processed: 1,247 records", type: "info" },
      { timestamp: "8 min ago", message: "Memory usage at 78%", type: "warning" },
      { timestamp: "15 min ago", message: "Model checkpoint saved", type: "info" },
      { timestamp: "30 min ago", message: "Batch processing started", type: "info" },
    ],
    nodes: [
  ...
  "2": {
    ...
    lastRun: "5 min ago",
    type: "Time Series",
    description: "Forecasts product demand based on historical data and market trends to optimize inventory management.",
    version: "1.8.3",
    ...
    logs: [
      { timestamp: "5 min ago", message: "Forecast generated for next 7 days", type: "info" },
      { timestamp: "10 min ago", message: "Data ingestion completed", type: "info" },
      { timestamp: "1 hour ago", message: "Model accuracy validated", type: "info" },
    ],
    nodes: [
      { id: "n6", name: "Main Controller", status: "online" },
    ],
  },
};
  ...
  return (
    <AppLayout>
      <div className="flex-1 overflow-auto p-6">
        {/* Back Button & Header */}
        <div className="mb-6">
          <Link href="/models" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-medium ${getStatusBadge(model.status)}`}>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{model.lastTrained}</p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{model.lastRun}</p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{model.nodes.length}</p>
                </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-base font-medium">Accuracy History</CardTitle>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={i} className="flex-1 flex flex-col items-center gap-2">
                    <div className="w-full flex flex-col items-center">
                      ...
                      <div
                        ...
                        style={{ height: `${(point.accuracy / maxAccuracy) * 100}px` }}
                      />
                    </div>
